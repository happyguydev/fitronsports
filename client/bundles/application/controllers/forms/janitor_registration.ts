...
class IJanitorRegistrationForm extends FormController {
  public searchModalTarget: HTMLDivElement;
  public facilitySearchTarget: HTMLButtonElement;
}

class JanitorRegistrationForm extends (FormController as typeof IJanitorRegistrationForm) {
  public static identifier = 'janitor-registration';
  public static targets = ['searchModal', 'facilitySearch'];
  public omittedFields = ['janitor[facility_name]', 'janitor[facility_id]'];
...
export default JanitorRegistrationForm;
