<template>
  <modal
    :title="$t('cancel_modal_request.page_title')"
    :description="$t('cancel_modal_request.description')"
  ...
  >
    ...
    >
      ...
      {{ $t('cancel_modal_request.save_draft') }}
    </button>
    <a
    ...
    >
      ...
      {{ $t('cancel_modal_request.delete_request') }}
    </a>
  </modal>
</template>
